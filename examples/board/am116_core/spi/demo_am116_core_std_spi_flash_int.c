 ...
 *
 * \par 源代码
 * \snippet demo_am116_core_std_spi_flash_int.c src_am116_core_std_spi_flash_int
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_am116_core_std_spi_flash_int
 * \copydoc demo_am116_core_std_spi_flash_int.c
 */
 
/** [src_am116_core_std_spi_flash_int] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_zlg116.h"
...
{
    AM_DBG_INFO("demo am116_core std spi flash int!\r\n");
