 ...
 *
 * \par 源代码
 * \snippet demo_am116_core_microport_eeprom.c src_am116_core_microport_eeprom
 *
 * \internal
...
/**
 * \addtogroup demo_if_am116_core_microport_eeprom
 * \copydoc demo_am116_core_microport_eeprom.c
 */

/** [src_am116_core_microport_eeprom] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo am116_core microport eeprom!\r\n");
