...
/**
 * \addtogroup demo_if_am116_core_std_tim17_pwm
 * \copydoc demo_am116_core_std_tim17_pwm.c
 */

/** [src_am116_core_std_tim17_pwm] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo am116_core std tim17 pwm!\r\n");
