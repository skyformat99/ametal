...
#ifndef __AM_ZLG_SPI_INT_H
#define __AM_ZLG_SPI_INT_H
...
/**
 * \addtogroup am_zlg_if_spi_int
 * \copydoc am_zlg_spi_int.h
 * @{
 */
 ...
 * \brief SPI设备信息结构体
 */
typedef struct am_zlg_spi_int_devinfo {
...
} am_zlg_spi_int_devinfo_t;

/**
 * \brief SPI设备
 */
typedef struct am_zlg_spi_int_dev {

    am_spi_serv_t                   spi_serve;         /**< \brief SPI标准服务句柄 */
    const am_zlg_spi_int_devinfo_t *p_devinfo; /**< \brief SPI设备信息的指针 */
